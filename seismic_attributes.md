...
The `sf_attributes` crate provides 20 seismic attributes for reservoir characterization, fault detection, and stratigraphic analysis.
...
```bash
cargo add sf_attributes
```

## Quick Start

```rust
use sf_attributes::amplitude::{RmsAmplitude, MeanAmplitude};
use sf_attributes::frequency::{InstantaneousFrequency, DominantFrequency};
...
**Example:**
```rust
use sf_attributes::amplitude::MeanAmplitude;
...
**Example:**
```rust
use sf_attributes::amplitude::MaxAmplitude;
...
**Example:**
```rust
use sf_attributes::amplitude::MinAmplitude;
...
**Example:**
```rust
use sf_attributes::amplitude::StdDeviation;
...
**Example:**
```rust
use sf_attributes::amplitude::Energy;
...
**Example:**
```rust
use sf_attributes::amplitude::AbsoluteSum;
...
**Example:**
```rust
use sf_attributes::amplitude::PeakToPeak;
...
**Example:**
```rust
use sf_attributes::amplitude::Variance;
...
**Example:**
```rust
use sf_attributes::amplitude::Skewness;
...
**Example:**
```rust
use sf_attributes::frequency::DominantFrequency;
...
**Example:**
```rust
use sf_attributes::frequency::PeakFrequency;
...
**Example:**
```rust
use sf_attributes::frequency::MeanFrequency;
...
**Example:**
```rust
use sf_attributes::frequency::MedianFrequency;
...
**Example:**
```rust
use sf_attributes::frequency::FrequencyCentroid;
...
**Example:**
```rust
use sf_attributes::frequency::FrequencyRms;
...
**Example:**
```rust
use sf_attributes::frequency::FrequencySkewness;
...
**Example:**
```rust
use sf_attributes::frequency::FrequencyKurtosis;
...
**Example:**
```rust
use sf_attributes::frequency::NarrowbandEnergy;
...
```rust
use sf_attributes::{AttributeSet, AttributeBuilder};
...
```rust
use sf_attributes::volume::VolumeAttributes;
...
```python
from stratforge.attributes import SeismicAttributes
